...
public class HistoryActivity extends ListActivity implements Searcher {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    if (postSnapshot.getKey().equals("history")) {
                        for (DataSnapshot postPostsnapshot : postSnapshot.getChildren()) {
                            ...
                            for (DataSnapshot childSnapshot : postPostsnapshot.getChildren()) {
                                //listPollHistory.add(postPostsnapshot.getValue().toString().substring(22, 37));
                    ...
                    if (postSnapshot.getKey().equals("polls")) {
                        for (DataSnapshot postPostsnapshot : postSnapshot.getChildren()) {
                            ...
                            if (mapPollHistory.get(postPostsnapshot.getKey()).contains(deviceid)) {
